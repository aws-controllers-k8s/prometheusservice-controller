...
// +kubebuilder:rbac:groups=prometheusservice.services.k8s.aws,resources=workspaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=prometheusservice.services.k8s.aws,resources=workspaces/status,verbs=get;update;patch
