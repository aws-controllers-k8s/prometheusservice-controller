...
const (
	finalizerString = "finalizers.prometheusservice.services.k8s.aws/Workspace"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("workspaces")
