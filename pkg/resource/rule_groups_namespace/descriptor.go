...
const (
	FinalizerString = "finalizers.prometheusservice.services.k8s.aws/RuleGroupsNamespace"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("rulegroupsnamespaces")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.RuleGroupsNamespace{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.RuleGroupsNamespace),
	}
}
