...
// +kubebuilder:rbac:groups=prometheusservice.services.k8s.aws,resources=rulegroupsnamespaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=prometheusservice.services.k8s.aws,resources=rulegroupsnamespaces/status,verbs=get;update;patch
