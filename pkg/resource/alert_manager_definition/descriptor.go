...
const (
	finalizerString = "finalizers.prometheusservice.services.k8s.aws/AlertManagerDefinition"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("alertmanagerdefinitions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.AlertManagerDefinition{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.AlertManagerDefinition),
	}
}
