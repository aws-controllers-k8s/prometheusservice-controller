...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.ScraperID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	f0, ok := fields["scraperID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: scraperID"))
	}
	r.ko.Status.ScraperID = &f0
