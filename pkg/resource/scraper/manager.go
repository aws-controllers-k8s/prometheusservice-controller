...
// +kubebuilder:rbac:groups=prometheusservice.services.k8s.aws,resources=scrapers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=prometheusservice.services.k8s.aws,resources=scrapers/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	statusCodeCandidates := []string{"ACTIVE"}
	if !ackutil.InStrings(*r.ko.Status.StatusCode, statusCodeCandidates) {
		return false, nil
	}
