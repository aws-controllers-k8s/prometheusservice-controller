...
const (
	FinalizerString = "finalizers.prometheusservice.services.k8s.aws/Scraper"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("scrapers")
